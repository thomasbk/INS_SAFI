...
- (void)deviceOrientationDidChangeWithNotification:(NSNotification*)notification {
    ...
    CGSize dialogSize = CGSizeMake(300,250 + kDatePickerDialogDefaultButtonHeight + kDatePickerDialogDefaultButtonSpacerHeight);
...
- (void)showWithTitle:(NSString*)title subtitle:(NSString*)subtitle doneButtonTitle:(NSString*)doneButtonTitle cancelButtonTitle:(NSString*)cancelButtonTitle defaultDate:(NSDate*)defaultDate minimumDate:(NSDate*)minimumDate maximumDate:(NSDate*)maximumDate datePickerMode:(UIDatePickerMode)datePickerMode callback:(DatePickerCallback)callback {
...
- (UIView*)createContainerView{
    ...
    titleLabel.font = [UIFont fontWithName:@"HelveticaBold" size:18];
    [dialogContainer addSubview:titleLabel];
    self.titleLabel = titleLabel;
    
    // Subtitle
    UILabel* subtitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(10,35,280,20)];
    subtitleLabel.textAlignment = NSTextAlignmentCenter;
    subtitleLabel.font = [UIFont fontWithName:@"HelveticaNeue-Light" size:14];
    [dialogContainer addSubview:subtitleLabel];
...
- (void)addButtonsToView:(UIView*)container {
    ...
    [cancelButton setTitleColor:[Functions colorWithHexString:TITLE_COLOR] forState:UIControlStateNormal];
    [cancelButton setTitleColor:[Functions colorWithHexString:TITLE_COLOR] forState:UIControlStateHighlighted];
    ...
    [doneButton setTitleColor:[Functions colorWithHexString:TITLE_COLOR] forState:UIControlStateNormal];
    [doneButton setTitleColor:[Functions colorWithHexString:TITLE_COLOR] forState:UIControlStateHighlighted];
