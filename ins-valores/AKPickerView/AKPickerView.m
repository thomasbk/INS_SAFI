...
@interface AKPickerView () <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, AKCollectionViewLayoutDelegate, UIGestureRecognizerDelegate>
...
- (void)reloadData
{
    ...
    self.selectedItem = [self.dataSource numberOfItemsInPickerView:self]/2;
	if ([self.dataSource numberOfItemsInPickerView:self]) {
