...
- (instancetype)initWithAddress:(NSString *)urlString ShowLoading:(Boolean) showLoading{
    return [self initWithURL:[NSURL URLWithString:urlString] ShowLoading:showLoading];
}

- (instancetype)initWithURL:(NSURL*)pageURL ShowLoading:(Boolean) showLoading{
    return [self initWithURLRequest:[NSURLRequest requestWithURL:pageURL] ShowLoading:showLoading];
}
