//
//  SolicitudesInversionViewController.swift
//  INSSAFI
//
...
class SolicitudesInversionViewController: UIViewController,UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let value = (solicitud["MS"] as? NSNumber)
        {
            cell.lblMonto.text = value.formatAmount()
        }
        else {
            cell.lblMonto.text = ""
        }
    ...
    func getSolicitudes() {
        ...
        let params = ["NI":user.getUser()!, "CU":user.getSelectedCuenta()!, "SC":"0", "TS":"I", "TK":user.getToken()!]
