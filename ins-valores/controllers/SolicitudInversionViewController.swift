//
//  SolicitudInversionViewController.swift
//  INSSAFI
//
...
class SolicitudInversionViewController: UIViewController,UIPickerViewDataSource, UIPickerViewDelegate, UITextFieldDelegate {
    ...
    func traerFondosCuentas() {
        ...
        let params = ["CU":user.getSelectedCuenta()!,"SC":String(describing: subcuentas[indexSubcuenta]["CS"] as! Int), "TS":"I","TK":user.getToken()!]
        let data = ["pConsulta":params]
        var dataString = "\(data)"
        dataString = dataString.replacingOccurrences(of: "[", with: "{")
        dataString = dataString.replacingOccurrences(of: "]", with: "}")
    ...
    func getJSONSolicitud(isTouch:Bool) -> JSONStandard {
        var params:JSONStandard = ["TV":isTouch ? "B" : "C", "TS":"I", "NI":user.getUser()!, "CF":String(describing: fondos[indexFondo]["CF"] as! Int), "CU":user.getSelectedCuenta()!, "SC":String(describing: subcuentas[indexSubcuenta]["CS"] as! Int), "CC":String(describing: lblCuentaBancaria.text!),"CB":cuentasBancarias[indexCuentaBancaria]["CB"] as! String,"OR":lblOrigen.text!,"MS":String(describing: lblMonto.text!),"TK":user.getToken()!]
